/*
** exec_ld.c for corewar in /u/epitech_2011s/sundas_c/public/vm
** 
** Made by marc buron
** Login   <buron_m@epitech.net>
** 
** Started on  Fri Dec  5 17:35:13 2008 marc buron
** Last update Wed Dec 10 23:23:56 2008 tugdual sarazin
*/
...
void		dir_l_ld(t_champ *tabchamp, int i, t_param *p1, char p2);
/*
** incremente l'indice dans le tab char et exec ld
*/
void		exec_ld(t_champ *tabchamp, int i)
{
  int		offset;
  t_param	*param1;
  char		param2;
  ...
  if (is_reg(param2) && (param1->typeparam == T_IND))
    ind_l_ld(tabchamp, i, param1, param2);
  if (is_reg(param2) && (param1->typeparam == T_DIR))
    dir_l_ld(tabchamp, i, param1, param2);
